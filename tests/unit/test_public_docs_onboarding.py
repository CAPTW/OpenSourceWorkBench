...
TUTORIAL_CURRENT_RELEASE_BULLET = (
    "- understand that `v0.1.5-rc3` is the current public prerelease and that "
    "`v0.1.5-rc2`, `v0.1.5-rc1` and `v0.1.3-rc1` records are historical"
)
