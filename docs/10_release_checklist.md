...
| Next release gate | `PENDING` | After [v0.1.4-rc1 candidate metadata alignment](release/v0_1_4_rc1_candidate.md), use `OSW-RELEASE-024_V0_1_4RC1_FINAL_REVALIDATION_NO_TAG` before any tag, asset build, or GitHub Release work. Live optional validation issues `#6`-`#11` remain deferred to suitable environments. |
