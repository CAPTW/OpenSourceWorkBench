...
| Next feature gate | `PENDING` | Remaining scope review selects `OSW-EXP-001_VFEA_SCOPE_DEFINITION` for issue `#17` as a planning-only next slice. Live optional validation issues `#6`-`#11` remain deferred to suitable environments. |
