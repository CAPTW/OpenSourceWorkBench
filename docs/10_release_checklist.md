...
| Item | Status | Evidence / decision |
| --- | --- | --- |
| Release gate result | `PASS_WITH_WARNINGS` | OSW-AUTO-072 prepared final patch package metadata `0.1.2`, and a later local final tag gate created annotated `v0.1.2` at `c39f21372ef837f096aa0d430cced82adc6f3485`. Current `develop` is ahead at `f42131845bee49a89ef40a8d21c0c146846ada25`; `v0.1.2` is preserved as historical local evidence, not retargeted. |
...
| Release version plan | `PASS_WITH_WARNINGS` | [License and version plan](13_license_and_version_plan.md) defines current package metadata `0.1.2`, historical local tags `v0.1.0-rc1`, `v0.1.0-rc2`, `v0.1.0-rc3`, `v0.1.0`, `v0.1.1-rc1`, `v0.1.1`, `v0.1.2-rc1`, and `v0.1.2`. Because current `develop` is ahead of `v0.1.2`, the next current candidate should use a new patch line such as `0.1.3rc1` / `v0.1.3-rc1`, not a moved historical tag. |
...
| Public tag push | `P1 BLOCKED` | Do not push `v0.1.0-rc1`, `v0.1.0-rc2`, `v0.1.0-rc3`, historical `v0.1.0`, local `v0.1.1-rc1`, local `v0.1.1`, local `v0.1.2-rc1`, or local `v0.1.2` unless a later explicit maintainer push/version gate approves the exact current release path. |
