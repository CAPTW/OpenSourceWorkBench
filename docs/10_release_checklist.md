...
| Release asset download smoke automation | `PASS` | [Release asset download smoke](release/release_asset_download_smoke.md) documents `tools/release/check_release_assets.py`, the QA wrapper, offline fixture tests, GitHub download verification, and optional full wheel/sdist/portable ZIP smoke. |
