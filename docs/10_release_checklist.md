...
| Next feature gate | `PENDING` | After [v0.1.4 completion review](roadmap/v0_1_4_completion_review.md) and the [release boundary decision](release/v0_1_3rc2_or_v0_1_4_decision.md), use `OSW-EXP-002_FEASPEC_IR_DESIGN` for the next planning-only design step, run an `OSW-VALID` live optional validation gate on a suitable machine, or start a dedicated `v0.1.4-rc1` metadata/revalidation gate. Live optional validation issues `#6`-`#11` remain deferred to suitable environments. |
