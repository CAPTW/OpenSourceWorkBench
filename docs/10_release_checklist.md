...
| Item | Status | Evidence / decision |
| --- | --- | --- |
| Release gate result | `PASS_WITH_WARNINGS` | OSW-RELEASE-003 aligns the current package metadata to `0.1.3rc1` for the next patch release-candidate line. The earlier annotated `v0.1.2` tag remains historical local evidence at `c39f21372ef837f096aa0d430cced82adc6f3485` and is not retargeted. |
...
| Release version plan | `PASS_WITH_WARNINGS` | [License and version plan](13_license_and_version_plan.md) defines current package metadata `0.1.3rc1`, planned local candidate tag `v0.1.3-rc1`, and historical local tags `v0.1.0-rc1`, `v0.1.0-rc2`, `v0.1.0-rc3`, `v0.1.0`, `v0.1.1-rc1`, `v0.1.1`, `v0.1.2-rc1`, and `v0.1.2`. `v0.1.3-rc1` is not created by metadata alignment and requires a dedicated local tag gate. |
...
| Final `v0.1.2` local tag | `PASS_WITH_WARNINGS` | A later local final tag gate created annotated `v0.1.2` at `c39f21372ef837f096aa0d430cced82adc6f3485` with no push. Current `develop` is ahead at `f42131845bee49a89ef40a8d21c0c146846ada25`, so `v0.1.2` must remain historical local evidence. |
...
| Preserve local `v0.1.2` after post-tag freeze/handoff work. | P1 | Release prompt | A later local final tag gate created annotated `v0.1.2`; OSW-RELEASE-002 verified current `develop` is ahead at `f42131845bee49a89ef40a8d21c0c146846ada25`. | Do not move, recreate, retarget, delete, overwrite, push, or publish `v0.1.2` as the current line; reconcile the next patch candidate first. |
| Preserve local `v0.1.3-rc1` gate boundary. | P1 | Release prompt | OSW-RELEASE-003 prepares `0.1.3rc1` metadata only. | Do not create, move, push, or publish `v0.1.3-rc1` without a later explicit local tag gate. |
