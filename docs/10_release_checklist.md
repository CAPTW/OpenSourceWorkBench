...
| Next feature gate | `PENDING` | After Issue `#14` closure, use `OSW-PLAN-005_V0_1_4_REMAINING_SCOPE_REVIEW` or `OSW-EXP-001_VFEA_SCOPE_DEFINITION` for issue `#17`. |
