...
| RC2 tag gate bypass | A current RC2 tag could be created before version metadata, release notes, QA, or rc1 preservation are verified | Require OSW-AUTO-045 version bump, feature-branch QA, squash merge, post-merge pre-tag QA, rc1 verification, and annotated rc2 verification | Do not create or push `v0.1.0-rc2`; rerun the focused RC2 gate after blockers are fixed |
