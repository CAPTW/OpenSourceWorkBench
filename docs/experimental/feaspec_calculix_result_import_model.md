...
records a future persistence contract for reviewed drafts. It defines output
layout, schema/versioning, path and overwrite policy, atomic-write strategy,
artifact reference policy, validation rules, CLI/GUI future entry points, and
