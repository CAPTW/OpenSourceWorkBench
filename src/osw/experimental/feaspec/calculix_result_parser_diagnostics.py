...
class CalculiXResultParserDiagnosticCode(str, Enum):
    ...
    FP_FRD_PARSE_NOT_IMPLEMENTED = "FP_FRD_PARSE_NOT_IMPLEMENTED"
    FP_FRD_BLOCK_SCAN_ONLY = "FP_FRD_BLOCK_SCAN_ONLY"
    FP_FRD_BLOCK_UNSUPPORTED = "FP_FRD_BLOCK_UNSUPPORTED"
    FP_FRD_BLOCK_TOO_LARGE = "FP_FRD_BLOCK_TOO_LARGE"
    FP_FRD_BLOCK_LIMIT_EXCEEDED = "FP_FRD_BLOCK_LIMIT_EXCEEDED"
    FP_FRD_UNKNOWN_RECORD = "FP_FRD_UNKNOWN_RECORD"
    FP_FRD_BINARY_UNSUPPORTED = "FP_FRD_BINARY_UNSUPPORTED"
    FP_FRD_FIELD_VALUES_NOT_PARSED = "FP_FRD_FIELD_VALUES_NOT_PARSED"
    FP_FRD_MESH_RECONSTRUCTION_FORBIDDEN = "FP_FRD_MESH_RECONSTRUCTION_FORBIDDEN"
    FP_FRD_UNITS_MISSING = "FP_FRD_UNITS_MISSING"
    FP_FRD_PROVENANCE_MISSING = "FP_FRD_PROVENANCE_MISSING"
    FP_FRD_RESULT_DATASET_WRITE_FORBIDDEN = "FP_FRD_RESULT_DATASET_WRITE_FORBIDDEN"
    FP_FRD_NO_RECOGNIZED_BLOCKS = "FP_FRD_NO_RECOGNIZED_BLOCKS"
    FP_FRD_REFERENCE_CANDIDATE_ONLY = "FP_FRD_REFERENCE_CANDIDATE_ONLY"
