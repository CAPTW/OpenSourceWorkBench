...
def __getattr__(name: str) -> object:
    ...
    if name == "OptionalSolverPluginManifestDeactivationPanel":
        from osw.gui.dialogs.optional_solver_plugin_manifest_deactivation_panel import (
            OptionalSolverPluginManifestDeactivationPanel,
        )

        return OptionalSolverPluginManifestDeactivationPanel
    ...
    if name == "OptionalSolverPluginManifestPersistencePanel":
        from osw.gui.dialogs.optional_solver_plugin_manifest_persistence_panel import (
            OptionalSolverPluginManifestPersistencePanel,
        )

        return OptionalSolverPluginManifestPersistencePanel
    if name == "OptionalSolverPluginManifestReactivationPanel":
    ...
    if name == "OptionalSolverPluginManifestReloadFileDialogPanel":
        from osw.gui.dialogs.optional_solver_plugin_manifest_reload_file_dialog_panel import (
            OptionalSolverPluginManifestReloadFileDialogPanel,
        )

        return OptionalSolverPluginManifestReloadFileDialogPanel
    if name == "OptionalSolverPluginManifestReloadAcceptancePanel":
        from osw.gui.dialogs.optional_solver_plugin_manifest_reload_acceptance_panel import (
            OptionalSolverPluginManifestReloadAcceptancePanel,
        )

        return OptionalSolverPluginManifestReloadAcceptancePanel
    if name == "OptionalSolverPluginManifestReloadAcceptancePersistencePanel":
        from osw.gui.dialogs.optional_solver_plugin_manifest_reload_acceptance_persistence_panel import (  # noqa: E501
            OptionalSolverPluginManifestReloadAcceptancePersistencePanel,
        )

        return OptionalSolverPluginManifestReloadAcceptancePersistencePanel
    if name == "OptionalSolverPluginManifestReloadAcceptancePersistenceWritePanel":
